...
{
public:
	class UUAEStateMachineComponent*                   UAEStateMachineComponent;                                 // 0x0338(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
