...
{
public:
	struct FScriptDelegate                             bIsEnabledDelegate;                                       // 0x0020(0x0016) (ZeroConstructor, InstancedReference)
	struct FText                                       ToolTipText;                                              // 0x0030(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData00[0x4];                                       // 0x003C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             ToolTipTextDelegate;                                      // 0x0040(0x0016) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             ToolTipWidgetDelegate;                                    // 0x0058(0x0016) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             VisibilityDelegate;                                       // 0x0068(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x00E8(0x0016) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             ForegroundColorDelegate;                                  // 0x0118(0x0016) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnTouchStart;                                             // 0x0160(0x0016) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnTouchMove;                                              // 0x0170(0x0016) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnTouchEnd;                                               // 0x0180(0x0016) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0D08(0x0016) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             ValueDelegate;                                            // 0x00D8(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x00DC(0x0004) MISSED OFFSET
	struct FScriptDelegate                             TextDelegate;                                             // 0x00E0(0x0016) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x09A0(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0418(0x0016) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             BrushDelegate;                                            // 0x0168(0x0016) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetBrushAsyncComplete;                                  // 0x0178(0x0016) (ZeroConstructor, InstancedReference)
	struct FLinearColor                                ColorAndOpacity;                                          // 0x0188(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0198(0x0016) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01C0(0x0016) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             ContentColorAndOpacityDelegate;                           // 0x00F0(0x0016) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             BackgroundDelegate;                                       // 0x01A8(0x0016) (ZeroConstructor, InstancedReference)
	struct FLinearColor                                BrushColor;                                               // 0x01B8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             BrushColorDelegate;                                       // 0x01C8(0x0016) (ZeroConstructor, InstancedReference)
	struct FVector2D                                   DesiredSizeScale;                                         // 0x01D8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01E0(0x0016) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMouseButtonUpEvent;                                     // 0x01F0(0x0016) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMouseMoveEvent;                                         // 0x0200(0x0016) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMouseDoubleClickEvent;                                  // 0x0210(0x0016) (Edit, ZeroConstructor, InstancedReference)
...
{
public:
	struct FScriptDelegate                             CheckedStateDelegate;                                     // 0x00E0(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x00DC(0x0004) MISSED OFFSET
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x00E0(0x0016) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0100(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnGenerateRowEvent;                                       // 0x00E8(0x0016) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00F8(0x0008) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x00E4(0x0004) MISSED OFFSET
	struct FScriptDelegate                             OnGetMenuContentEvent;                                    // 0x00E8(0x0016) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0110(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             PercentDelegate;                                          // 0x02C0(0x0016) (ZeroConstructor, InstancedReference)
	struct FLinearColor                                FillColorAndOpacity;                                      // 0x02D0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             FillColorAndOpacityDelegate;                              // 0x02E0(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x00F8(0x0008) MISSED OFFSET
	struct FScriptDelegate                             TextDelegate;                                             // 0x0100(0x0016) (ZeroConstructor, InstancedReference)
...
{
public:
	TMap<class UObject*, class UShareWidgetRT*>        SharedWidgetRTMap;                                        // 0x0338(0x0050) (ZeroConstructor)
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0130(0x0016) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x01D8(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnGenerateTileEvent;                                      // 0x00E8(0x0016) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00F8(0x0008) MISSED OFFSET
