...
{
public:
	struct FScriptMulticastDelegate                    OnUnitTakeDamage;                                         // 0x0440(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      bEnableTeamAI : 1;                                        // 0x044C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x3];                                       // 0x044D(0x0003) MISSED OFFSET
	TArray<class UClass*>                              TeamAIClasses;                                            // 0x0450(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                SpawnerTeamID;                                            // 0x045C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EBotCategray>                     SpeciesCategory;                                          // 0x0460(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0461(0x0003) MISSED OFFSET
	int                                                SpawnerCampItemID;                                        // 0x0464(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                GroupID;                                                  // 0x0468(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UActorComponent*>                     TeamAIComponents;                                         // 0x046C(0x000C) (ExportObject, ZeroConstructor)
...
public:
	...
	struct FScriptDelegate                             GetDynamicItemDurabilityDelegate;                         // 0x0160(0x0016) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	unsigned char                                      UnknownData01[0x30];                                      // 0x0F68(0x0030) MISSED OFFSET
	TMap<int, class APickUpWrapperActor*>              CacheAINearbyItem;                                        // 0x0F98(0x0050) (ZeroConstructor)
	TArray<class ASTExtraBaseCharacter*>               CacheNearbyEnemies;                                       // 0x0FD4(0x000C) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x0FE0(0x001C)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x0FFC(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x1000(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x1004(0x000C) MISSED OFFSET
...
// 0x0638 (0x1648 - 0x1010)
class UAIStateInfoComponentBRBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoBRBase                          CacheAIStateInfoBRBase;                                   // 0x1010(0x0188)
	struct FAIStateInfoBRBase                          LastAIStateInfoBRBase;                                    // 0x1198(0x0188)
	struct FDiffAIStateInfoBRBaseGeneral               CacheDiffAIStateInfoBRBaseGeneral;                        // 0x1320(0x01E8)
	struct FDiffAIStateInfoBRBase                      CacheDiffAIStateInfoBRBase;                               // 0x1508(0x0140)
...
// 0x0178 (0x1188 - 0x1010)
class UAIStateInfoComponentMPBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoMPBase                          CacheAIStateInfoMPBase;                                   // 0x1010(0x0078)
	struct FAIStateInfoMPBase                          LastAIStateInfoMPBase;                                    // 0x1088(0x0078)
	struct FDiffAIStateInfoMPBaseGeneral               CacheDiffAIStateInfoMPBaseGeneral;                        // 0x1100(0x0088)
...
// 0x00A8 (0x1230 - 0x1188)
class UAIStateInfoComponentTeamDeath : public UAIStateInfoComponentMPBase
{
public:
	struct FAIStateInfoTeamDeath                       CacheAIStateInfoTeamDeath;                                // 0x1188(0x0038)
	struct FAIStateInfoTeamDeath                       LastAIStateInfoTeamDeath;                                 // 0x11C0(0x0038)
	struct FDiffAIStateInfoTeamDeathGeneral            CacheDiffAIStateInfoTeamDeathGeneral;                     // 0x11F8(0x0038)
...
public:
	...
	unsigned char                                      bFilterBuilding : 1;                                      // 0x00A4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFilterWater : 1;                                         // 0x00A4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReachableTest : 1;                                       // 0x00A4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFilterOutBehaviorRegion : 1;                             // 0x00A4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseNavmesh : 1;                                          // 0x00A4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00A5(0x0003) MISSED OFFSET
	struct FName                                       SpecificNaVName;                                          // 0x00A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ECollisionChannel>                CollisionChannel;                                         // 0x00B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00B1(0x0003) MISSED OFFSET
	float                                              MaxLocationTraceHeightZ;                                  // 0x00B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TMap<TEnumAsByte<enum ESTEPoseState>, struct FCameraViewPitchLimitData> CameraViewPitchLimitDataMap;                              // 0x00E8(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	bool                                               bNotiyParachuteComp;                                      // 0x0190(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                ZoneID;                                                   // 0x0338(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Radius;                                                   // 0x033C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Type;                                                     // 0x0340(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDynamic;                                                // 0x0344(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0345(0x0003) MISSED OFFSET
	int                                                CustomState;                                              // 0x0348(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USpecialZoneShapeComponent*                  SpecialZoneShapeComponent;                                // 0x034C(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor*                                      CacheParentActor;                                         // 0x0350(0x0004) (ZeroConstructor, IsPlainOldData)
