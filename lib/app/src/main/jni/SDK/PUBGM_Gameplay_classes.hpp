...
{
public:
	unsigned char                                      AutoDormancyType;                                         // 0x03C8(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bStatic;                                                  // 0x03C9(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	ERegionSizeIndex                                   RegionSize;                                               // 0x03CA(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bNeedUpdateNetworkInfo;                                   // 0x03CB(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
// 0x0180 (0x07D0 - 0x0650)
class AUAECharacter : public ACharacter
{
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0650(0x0038) MISSED OFFSET
	int                                                iRegionCharacter;                                         // 0x0688(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x068C(0x0004) MISSED OFFSET
	struct FName                                       RepPropertyCategory;                                      // 0x0690(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       PlayerType;                                               // 0x0698(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     PlayerName;                                               // 0x06A0(0x000C) (Net, ZeroConstructor)
	struct FString                                     Nation;                                                   // 0x06AC(0x000C) (Net, ZeroConstructor)
	uint32_t                                           PlayerKey;                                                // 0x06B8(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	struct FString                                     PlayerUID;                                                // 0x06BC(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	struct FString                                     MLAIPlayerUID;                                            // 0x06C8(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	int                                                TeamID;                                                   // 0x06D4(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bTeamLeader;                                              // 0x06D8(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x06D9(0x0003) MISSED OFFSET
	int                                                CampID;                                                   // 0x06DC(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	int                                                resID;                                                    // 0x06E0(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	ECharacterGender                                   DefaultCharacterGender;                                   // 0x06E4(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x06E5(0x0003) MISSED OFFSET
	TArray<struct FGameModePlayerItem>                 InitialItemList;                                          // 0x06E8(0x000C) (ZeroConstructor)
	struct FGameModePlayerUpassInfo                    UpassInfo;                                                // 0x06F4(0x0030)
	struct FGameModePlayerPetInfo                      PetInfo;                                                  // 0x0724(0x001C) (BlueprintVisible)
	int                                                planeAvatarId;                                            // 0x0740(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DyeDebugFlag;                                             // 0x0744(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FGameModePlayerTaskData>             InitialTaskDataList;                                      // 0x0748(0x000C) (ZeroConstructor)
	bool                                               bIsAI;                                                    // 0x0754(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsMLAI;                                                  // 0x0755(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsAIWithPet;                                             // 0x0756(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAINeedCheckBullets;                                      // 0x0757(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DestinyValue;                                             // 0x0758(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC];                                       // 0x075C(0x000C) MISSED OFFSET
	float                                              RatingScore;                                              // 0x0768(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               UseWholeBodyModel;                                        // 0x076C(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bEnsure;                                                  // 0x076D(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bMEnsure;                                                 // 0x076E(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               DefaultIsUseWholeBodyModel;                               // 0x076F(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC];                                       // 0x0770(0x000C) MISSED OFFSET
	struct FString                                     LuaFilePath;                                              // 0x077C(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x0788(0x003C) (Net)
	unsigned char                                      UnknownData06[0xC];                                       // 0x07C4(0x000C) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             SendTeammateResultWhenChicken;                            // 0x0820(0x0016) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             HaveSentTeamBattleResult;                                 // 0x0830(0x0016) (ZeroConstructor, InstancedReference)
...
public:
	...
	int                                                DeathsCount;                                              // 0x0530(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0534(0x0004) MISSED OFFSET
	int                                                MlAIDeliverNum;                                           // 0x0538(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                OriginalMlAIDeliverNum;                                   // 0x053C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Assists;                                                  // 0x0540(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	TArray<uint64_t>                                   AssistTeammatesList;                                      // 0x0544(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x3C];                                      // 0x0550(0x003C) MISSED OFFSET
	TArray<int>                                        OvertimeAssistsTime;                                      // 0x058C(0x000C) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      PlatformGender;                                           // 0x0598(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0599(0x0003) MISSED OFFSET
	int                                                MatchStrategyLabel;                                       // 0x059C(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	int                                                MatchLabel;                                               // 0x05A0(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	uint32_t                                           Killer;                                                   // 0x05A4(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           KillerIGPlayerKey;                                        // 0x05A8(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BeKilledOpenID;                                           // 0x05AC(0x000C) (ZeroConstructor)
	struct FString                                     KillerName;                                               // 0x05B8(0x000C) (ZeroConstructor)
	uint32_t                                           KillerType;                                               // 0x05C4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                KillerWeaponID;                                           // 0x05C8(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           KillerDeliveryType;                                       // 0x05CC(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           DeadCircleIndex;                                          // 0x05D0(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData06[0xC];                                       // 0x065C(0x000C) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x3];                                       // 0x0679(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x3];                                       // 0x0701(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData09[0x3];                                       // 0x07DD(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData11[0x8];                                       // 0x08D0(0x0008) MISSED OFFSET
	bool                                               bIsGameTerminator;                                        // 0x08D8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x08D9(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData14[0x3];                                       // 0x0A9D(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData15[0x3];                                       // 0x0B35(0x0003) MISSED OFFSET
	unsigned char                                      UnknownData16[0x3C];                                      // 0x0B35(0x003C) UNKNOWN PROPERTY: SetProperty Gameplay.UAEPlayerState.UseHelicoperRecord
	...
	unsigned char                                      UnknownData17[0x8];                                       // 0x0C18(0x0008) MISSED OFFSET
	struct FScriptDelegate                             AllowToAddGeneralCount;                                   // 0x0C20(0x0016) (ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData18[0x3];                                       // 0x0C91(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData19[0x3];                                       // 0x0CD5(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData21[0x10];                                      // 0x0E50(0x0010) MISSED OFFSET
	bool                                               IsOnline;                                                 // 0x0E60(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData22[0x17];                                      // 0x0E61(0x0017) MISSED OFFSET
	struct FGameBaseInfo                               GameBaseInfo;                                             // 0x0E78(0x0078) (Net)
	unsigned char                                      UnknownData23[0x4];                                       // 0x0EF0(0x0004) MISSED OFFSET
...
{
public:
	int                                                iRegionHouse;                                             // 0x03D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              WindowHideDistanceSquared;                                // 0x03D4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              WindowLoadDistanceSquared;                                // 0x03D8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              WindowLoadDistanceSquaredOnVeryLowDevice;                 // 0x03DC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              WindowLoadDistanceSquaredOnServer;                        // 0x03E0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<struct FUAEWindowRepData>                   WindowList;                                               // 0x03E4(0x000C) (Net, ZeroConstructor)
	TMap<int, class UUAEWindowComponent*>              WindowComponents;                                         // 0x03F0(0x0050) (ExportObject, ZeroConstructor, Transient)
	bool                                               bEnableWindow;                                            // 0x042C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bShouldConsiderDistance;                                  // 0x042D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4E];                                      // 0x042E(0x004E) MISSED OFFSET
...
{
public:
	bool                                               IsServerAlreadyExplodedCpp;                               // 0x03C8(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03C9(0x0003) MISSED OFFSET
	struct FVector                                     ProjInitialRelativeOffset;                                // 0x03CC(0x000C) (BlueprintVisible, Net, IsPlainOldData)
	struct FVector                                     ProjStandOffset;                                          // 0x03D8(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, IsPlainOldData)
	struct FVector                                     ProjCrouchOffset;                                         // 0x03E4(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, IsPlainOldData)
	struct FVector                                     ProjProneOffset;                                          // 0x03F0(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, IsPlainOldData)
	TEnumAsByte<enum ECharacterPoseType>               ProjPrevoisOwnerPose;                                     // 0x03FC(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03FD(0x0003) MISSED OFFSET
	float                                              SpawnSeconds;                                             // 0x0400(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowGrenadeWarningFlag;                                  // 0x0404(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsGroundedOnServerCpp;                                   // 0x0405(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FGameModePlayerKnapsackSingleInfo           InitialSharedKnapsack;                                    // 0x07F8(0x0054) (BlueprintVisible, Net)
	bool                                               bSharedSkinOpened;                                        // 0x084C(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bUsingSharedSkin;                                         // 0x084D(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bSubscribeBagOpened;                                      // 0x084E(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x1];                                       // 0x084F(0x0001) MISSED OFFSET
	int                                                FashionBagStartIndex;                                     // 0x0850(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	int                                                VehicleSkinInReady;                                       // 0x0854(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bSpwanInVehiclePlayerStart;                               // 0x0858(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0859(0x0003) MISSED OFFSET
	TArray<struct FGameModePlayerItem>                 InitialWeaponAvatarList;                                  // 0x085C(0x000C) (BlueprintVisible, ZeroConstructor)
	struct FGameModePlayerPetInfo                      InitialPetInfo;                                           // 0x0868(0x001C) (BlueprintVisible, BlueprintReadOnly, Net)
	TArray<struct FGameModePlayerPetInfo>              AdditionalPetInfo;                                        // 0x0884(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	int                                                UsingAdditionalPetIndex;                                  // 0x0890(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	TArray<struct FGameModePlayerKnapsackExtInfo>      InitialKnapsackExtInfo;                                   // 0x0894(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	TArray<struct FGameModePlayeWeaponSchemeInfo>      InitialWeaponSchemeInfo;                                  // 0x08A0(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnInitialWeaponScheme;                                    // 0x08AC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	int                                                CurWeaponSchemeIndex;                                     // 0x08B8(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	int                                                PveLevel;                                                 // 0x08BC(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	TArray<int>                                        InitialCharSkillList;                                     // 0x08C0(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 InitialVehicleAvatarList;                                 // 0x08CC(0x000C) (BlueprintVisible, ZeroConstructor)
	TArray<struct FGameModePlayerItems>                InitialVehicleAvatarSkinList;                             // 0x08D8(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	int                                                ShowVehicleSkin;                                          // 0x08E4(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FGameModePlayerItem>                 InitialBackPackPendantList;                               // 0x08E8(0x000C) (BlueprintVisible, ZeroConstructor)
	TArray<struct FVehicleAvatarData>                  InitialVehicleAdvanceAvatarList;                          // 0x08F4(0x000C) (BlueprintVisible, ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 InitialVehicleMusicList;                                  // 0x0900(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	struct FGameModePlayerConsumableAvatar             InitialConsumableAvatar;                                  // 0x090C(0x0010) (BlueprintVisible, Net)
	struct FGameModePlayerEquipmentAvatar              InitialEquipmentAvatar;                                   // 0x091C(0x000C) (BlueprintVisible, Net)
	TMap<int, int>                                     WeaponAvatarItemList;                                     // 0x0928(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      UnknownData11[0x3C];                                      // 0x0964(0x003C) MISSED OFFSET
	TMap<int, int>                                     GrenadeAvatarItemList;                                    // 0x09A0(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FGameModeWeaponAvatarData>           WeaponAvatarDataList;                                     // 0x09DC(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	TMap<int, int>                                     VehicleAvatarList;                                        // 0x09E8(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<int, struct FVehicleAvatarData>               VehicleAdvanceAvatarList;                                 // 0x0A24(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<int, struct FVehicleAvatarSkinList>           VehicleAvatarSkinList;                                    // 0x0A60(0x0050) (BlueprintVisible, ZeroConstructor)
	TArray<int>                                        VehicleMusicList;                                         // 0x0A9C(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	TArray<int>                                        DefaultVehicleMusic;                                      // 0x0AA8(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	TArray<struct FGameModePlayerExpressionItem>       InitialExpressionItemList;                                // 0x0AB4(0x000C) (ZeroConstructor)
	TArray<struct FGameModeWeaponDIYPlanData>          InitialWeaponDIYPlanData;                                 // 0x0AC0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<int, int>                                     WeaponDIYPlanDataMap;                                     // 0x0ACC(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<int, int>                                     InitialWeaponPendantList;                                 // 0x0B08(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FGameModePlayerTaskData>             InitialTaskDataList;                                      // 0x0B44(0x000C) (ZeroConstructor)
	TArray<struct FSpecialPickItem>                    InitialSpecialPickItemList;                               // 0x0B50(0x000C) (ZeroConstructor)
	TArray<struct FDailyTaskStoreInfo>                 DailyTaskStoreList;                                       // 0x0B5C(0x000C) (ZeroConstructor)
	uint32_t                                           TaskSyncToDsTs;                                           // 0x0B68(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnPlayerGotoSpectatingDelegate;                           // 0x0B6C(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData12[0x8];                                       // 0x0B78(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnReceiveUIMessage;                                       // 0x0B80(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0B8C(0x0004) MISSED OFFSET
	int64_t                                            LastGameResultTime;                                       // 0x0B90(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bRoomCanKickPlayer;                                       // 0x0B98(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bCanDownloadInBattle;                                     // 0x0B99(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x2];                                       // 0x0B9A(0x0002) MISSED OFFSET
	struct FString                                     IpCountryStr;                                             // 0x0B9C(0x000C) (ZeroConstructor)
	bool                                               bRoomOwner;                                               // 0x0BA8(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bOpenChangeWearing;                                       // 0x0BA9(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x2];                                       // 0x0BAA(0x0002) MISSED OFFSET
	uint32_t                                           ObserverFlags;                                            // 0x0BAC(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bIsSpectating;                                            // 0x0BB0(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x3];                                       // 0x0BB1(0x0003) MISSED OFFSET
	struct FLobbyWatchInfo                             LobbyWatchInfo;                                           // 0x0BB4(0x0008) (Net)
	int                                                HawkEyeSpectateMaxMatchCount;                             // 0x0BBC(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                HawkEyeSpectateUsedMatchCount;                            // 0x0BC0(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bIsWatchEnd;                                              // 0x0BC4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x3];                                       // 0x0BC5(0x0003) MISSED OFFSET
	float                                              UpdateOBCircleCounter;                                    // 0x0BC8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              UpdateOBCircleInterval;                                   // 0x0BCC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAllowAutoSelectTeamMate;                                 // 0x0BD0(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bWaitRetryGotoSpectating;                                 // 0x0BD1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData18[0x2];                                       // 0x0BD2(0x0002) MISSED OFFSET
	TArray<struct FString>                             FriendObservers;                                          // 0x0BD4(0x000C) (Net, ZeroConstructor)
	unsigned char                                      UnknownData19[0x1];                                       // 0x0BE0(0x0001) MISSED OFFSET
	bool                                               bCanLedgeGrab;                                            // 0x0BE1(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData20[0x6];                                       // 0x0BE2(0x0006) MISSED OFFSET
	bool                                               bIsSpectatingEnemy;                                       // 0x0BE8(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData21[0x47];                                      // 0x0BE9(0x0047) MISSED OFFSET
	TWeakObjectPtr<class UUAEUserWidget>               InGameUIRoot;                                             // 0x0C30(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData22[0x3];                                       // 0x0C38(0x0003) MISSED OFFSET
	bool                                               bExited;                                                  // 0x0C3B(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bReconnected;                                             // 0x0C3C(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bReconnecting;                                            // 0x0C3D(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData23[0xE];                                       // 0x0C3E(0x000E) MISSED OFFSET
	struct FScriptMulticastDelegate                    PlayerControllerLostDelegate;                             // 0x0C4C(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SyncDailyTaskInfoDelegate;                                // 0x0C58(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerRecoveredDelegate;                        // 0x0C64(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerAboutToReconnectDelegate;                 // 0x0C70(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerReconnectedDelegate;                      // 0x0C7C(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerAboutToRespawnDelegate;                   // 0x0C88(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerRespawnedDelegate;                        // 0x0C94(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerAboutToExitDelegate;                      // 0x0CA0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPlayerQuitSpectatingForClient;                          // 0x0CAC(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPlayerControllerBattleBeginPlay;                        // 0x0CB8(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitGameUI;                                             // 0x0CC4(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData24[0xC];                                       // 0x0CD0(0x000C) MISSED OFFSET
	bool                                               bCanWatchEnemyInRoomMode;                                 // 0x0CDC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData25[0x7F];                                      // 0x0CDD(0x007F) MISSED OFFSET
	TArray<class UObject*>                             SecurityObjs;                                             // 0x0D5C(0x000C) (ZeroConstructor)
	TArray<int>                                        BuffEffectDisplayIDArray;                                 // 0x0D68(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	bool                                               IsDelayNotifyEnterBattleUntilLevelLoad;                   // 0x0D74(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData26[0x3];                                       // 0x0D75(0x0003) MISSED OFFSET
	float                                              NotifyTimeOut;                                            // 0x0D78(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DelayCloseLoadingTime;                                    // 0x0D7C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FString                                     NeedLoadLevelName;                                        // 0x0D80(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     NeedLoadedLevelFullName;                                  // 0x0D8C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               IsTickHouse;                                              // 0x0D98(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData27[0xF];                                       // 0x0D99(0x000F) MISSED OFFSET
	int                                                AntiDataCD;                                               // 0x0DA8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ModeID;                                                   // 0x0DAC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bOpenReconnectUseCharViewPoint;                           // 0x0DB0(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData28[0x23];                                      // 0x0DB1(0x0023) MISSED OFFSET
	float                                              ClientToDSFlowLimitTime;                                  // 0x0DD4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ClientToDSFlowLimit;                                      // 0x0DD8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData29[0x10];                                      // 0x0DDC(0x0010) MISSED OFFSET
	struct FString                                     UsingNetObjectPathNameMappingCSV;                         // 0x0DEC(0x000C) (Net, ZeroConstructor)
	struct FString                                     UsingOodleNetworkDicPath;                                 // 0x0DF8(0x000C) (Net, ZeroConstructor)
	unsigned char                                      UnknownData30[0x18];                                      // 0x0E04(0x0018) MISSED OFFSET
	class ANetworkReportActor*                         NetworkReportActor;                                       // 0x0E1C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData31[0x8];                                       // 0x0E20(0x0008) MISSED OFFSET
...
{
public:
	class UCapsuleComponent*                           CollisionComponent;                                       // 0x0338(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	bool                                               bInitComponents;                                          // 0x033C(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UBoxComponent*                               Area;                                                     // 0x0338(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x033C(0x0004) MISSED OFFSET
...
{
public:
	int                                                LossRateArrayNum;                                         // 0x0338(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MaxCacheLossRateArrayNum;                                 // 0x033C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     InPacketLossRateArrayStr;                                 // 0x0340(0x000C) (ZeroConstructor)
	struct FString                                     OutPacketLossRateArrayStr;                                // 0x034C(0x000C) (ZeroConstructor)
...
public:
	...
	bool                                               bMultiAdvertisement;                                      // 0x038C(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x038D(0x0003) MISSED OFFSET
	TMap<unsigned char, class UTexture2D*>             IdTextureMap;                                             // 0x0390(0x0050) (BlueprintVisible, ZeroConstructor)
	class UStaticMesh*                                 StaticMesh;                                               // 0x03CC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FString                                     StaticMeshPath;                                           // 0x03D0(0x000C) (Net, ZeroConstructor)
	class UFrontendHUD*                                FrontendHUD;                                              // 0x03DC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ID;                                                       // 0x03E0(0x0004) (Net, ZeroConstructor, IsPlainOldData)
...
public:
	...
	ERegionSizeIndex                                   RegionSize;                                               // 0x03EC(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bRegionStatic;                                            // 0x03ED(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	TMap<struct FVector, class AActor*>                ActorsMap;                                                // 0x0338(0x0050) (Edit, ZeroConstructor)
...
{
public:
	class AController*                                 InstigatorController;                                     // 0x0338(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x033C(0x0004) MISSED OFFSET
...
{
public:
	bool                                               bIsEditorOnly;                                            // 0x0338(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EIndependentSpotType                               SpotType;                                                 // 0x0339(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class APawn*                                       LastInstigatorPawn;                                       // 0x0800(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	class UStaticMesh*                                 BrokenMesh;                                               // 0x0804(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UParticleSystem*                             BrokenEffect;                                             // 0x0808(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x54];                                      // 0x080C(0x0054) MISSED OFFSET
