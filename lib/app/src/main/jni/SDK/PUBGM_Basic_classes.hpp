...
{
public:
	int                                                iRegionActor;                                             // 0x03C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x03CC(0x0002) MISSED OFFSET
	bool                                               bStaticAddNetworkActor;                                   // 0x03CE(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      AutoDormancyType;                                         // 0x03CF(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UDataTableRowDesc*                           Desc;                                                     // 0x00A8(0x0004) (ZeroConstructor, IsPlainOldData)
