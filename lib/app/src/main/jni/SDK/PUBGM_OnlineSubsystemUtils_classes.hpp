...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x033C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x0340(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x0344(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x0338(0x000C) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0344(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0348(0x000C) (ZeroConstructor)
...
public:
	...
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0380(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0381(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0384(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0388(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
