...
public:
	...
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0658(0x000C) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x0664(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x0668(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x066C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawLabels : 1;                                          // 0x066D(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x066D(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x066D(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x066D(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x066D(0x0001) (Edit)
	TEnumAsByte<enum EEnvQueryRunMode>                 QueryingMode;                                             // 0x066E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x21];                                      // 0x066F(0x0021) MISSED OFFSET
