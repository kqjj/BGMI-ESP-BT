...
{
public:
	float                                              Interval;                                                 // 0x0338(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FVector>                             PortalLoctions;                                           // 0x033C(0x000C) (Edit, ZeroConstructor)
...
{
public:
	class UClass*                                      CharacterClass;                                           // 0x0BE0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
