...
public:
	...
	unsigned char                                      UnknownData02[0x33C];                                     // 0x0074(0x033C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData05[0x7AC];                                     // 0x030C(0x07AC) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0AB8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x5C];                                      // 0x0ABC(0x005C) MISSED OFFSET
	TArray<struct FString>                             MatchedApps;                                              // 0x0B18(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData07[0x14];                                      // 0x0B24(0x0014) MISSED OFFSET
	TArray<struct FString>                             ReceivedInstalledApp;                                     // 0x0B38(0x000C) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnServerReceiveInstalledAppDelegate;                      // 0x0B44(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData08[0x1C];                                      // 0x0B50(0x001C) MISSED OFFSET
	int                                                ReceivedRotationModifiedCount;                            // 0x0B6C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedTranslationModifiedCount;                         // 0x0B70(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedScale3DModifiedCount;                             // 0x0B74(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        LastInvalidIndexListInPakLite;                            // 0x0B78(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x4];                                       // 0x0B84(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnServerReceiveInvalidFilesInPakLiteDelegate;             // 0x0B88(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData10[0xB8];                                      // 0x0B94(0x00B8) MISSED OFFSET
	float                                              TouchScreenActiveTimeRatioThreshold;                      // 0x0C4C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0C50(0x0004) MISSED OFFSET
	float                                              MouTa;                                                    // 0x0C54(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BandaCountThreshold;                                      // 0x0C58(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bEnableBandCount;                                         // 0x0C5C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x0C5D(0x0003) MISSED OFFSET
	float                                              IntervalThreshold1;                                       // 0x0C60(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HongThreshold;                                            // 0x0C64(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              NovoThreshold;                                            // 0x0C68(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0C6C(0x0004) MISSED OFFSET
