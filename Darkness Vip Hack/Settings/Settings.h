...
namespace Settings {
	...
	extern int Tab;
	extern int curraim;
	extern string notifysate;

	extern bool sendscreenshot;

	//aim
	extern int currentBoneIndex;
	extern int weight;
	extern bool isPrioritySet;
	...
	extern bool peekdetect;
	extern int macroval;
	extern int aimbotmode;
	extern int bulletrackMode;
	...
	extern bool ModSKin;
	extern bool visbulletcheck;
	extern int prediction;
	extern bool carsex;
	extern int carsexkey;
	extern bool internalTrack;
	extern int fovinternal;
	extern int rangeinternal;
...
#pragma region Items 
	...
	extern bool ExtendedMac;
	extern bool Supressor;
	...
	extern ImVec4 ExtendedMacColor;
	extern ImVec4 SupressorColor;
	extern ImVec4 visColor;
#pragma endregion 
}
namespace ModSkin {
	extern int Suit;
