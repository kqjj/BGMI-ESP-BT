...
bool ImGui::Checkbox(const char* label, bool* v, float col[4])
{
    ...
    auto bg_col = ImTricks::Animations::FastColorLerp(ImGui::GetColorU32(ImGuiCol_FrameBg), ImGui::GetColorU32(ImGuiCol_Text), enabled_anim);
    auto dot_col = ImTricks::Animations::FastColorLerp(ImGui::GetColorU32(ImGuiCol_TextDisabled), ImGui::GetColorU32(ImGuiCol_SliderGrab), enabled_anim);
